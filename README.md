...
This version has been optimized to run on a mobile device, and will have a limited functionality and game library compared to the desktop version.

This is just because many games that are on the desktop version are not compatiable with a mobile environment.
